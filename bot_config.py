...
async def send_msg(msg, user_msg,bot_self_mention_string, private):
    ...
    if msg.channel.name in channels_on:
        if msg.content.startswith(bot_self_mention_string):
            try:
                resp_name = responses.handle_name_response(user_msg, bot_self_mention_string, user_msg.author)
                if resp_name:
...
async def auto_test(msg):
    ...
    dice = ["2", "3", "4", "6", "8", "10", "11", "12", "16", "20", "24", "30", "66", "100", "1000","20a", "20d", "100kk", "100pp", "100kp", "100pk", "100k", "100p", "20*2", "20+2", "20-2", "10+2+2+5-3*2"]   # Example dice      
