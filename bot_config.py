...
channels_on = ["sala_spotkań", "dział_techcznicny", "warhammer", "darkheresy", "gra", "gra-u-szadka", "dungeonsanddragons", "neuroshima", "zew", "rzuty-w-trakcie-sesji", "testy", "DD", "ZEW", "WARHAMMER", "GRA", "DCC", "OSE", "jednostrzały", "DD 5e", "CYBERPUNKRED", "Sesja publiczna", "SESJA PUBLICZNA", "generau-czat", "Mothership", "Traveller", "DELTA GREEN"]
