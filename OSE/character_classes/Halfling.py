...
class Halfling(object):
    def __init__(self, strength: OSE.statistics.Strength, intelligence: OSE.statistics.Intelligence,
        ...
        self.level_progression = {1:  [     0, "1d6", 0, 8, 9, 10, 13, 12],
                                  2:  [  2000, "2d6", 0, 8, 9, 10, 13, 12],
                                  3:  [  4000, "3d6", 0, 8, 9, 10, 13, 12],
                                  4:  [  8000, "4d6", 2, 6, 7,  8, 10, 10],
                                  5:  [ 16000, "5d6", 2, 6, 7,  8, 10, 10],
                                  6:  [ 32000, "6d6", 2, 6, 7,  8, 10, 10],
                                  7:  [ 64000, "7d6", 5, 5, 6,  6,  7,  8],
                                  8:  [120000, "8d6", 5, 5, 6,  6,  7,  8],
                                  }
        self.spells = None
