...
class Cleric(object):
    def __init__(self, strength: OSE.statistics.Strength, intelligence: OSE.statistics.Intelligence,
        ...
        self.level_progression = {1:  [     0, "1d6", 0, 11, 12, 14, 16, 15],
                                  2:  [  1500, "2d6", 0, 11, 12, 14, 16, 15],
                                  3:  [  3000, "3d6", 0, 11, 12, 14, 16, 15],
                                  4:  [  6000, "4d6", 0, 11, 12, 14, 16, 15],
                                  5:  [ 12000, "5d6", 2,  9, 10, 12, 14, 12],
                                  6:  [ 25000, "6d6", 2,  9, 10, 12, 14, 12],
                                  7:  [ 50000, "7d6", 2,  9, 10, 12, 14, 12],
                                  8:  [100000, "8d6", 2,  9, 10, 12, 14, 12],
                                  9:  [200000, "9d6", 5,  6,  7,  9, 11,  9],
                                  10: [300000, "9d6", 5,  6,  7,  9, 11,  9],
                                  11: [400000, "9d6", 5,  6,  7,  9, 11,  9],
                                  12: [500000, "9d6", 5,  6,  7,  9, 11,  9],
