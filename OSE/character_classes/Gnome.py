...
class Gnome(object):
    def __init__(self, strength: OSE.statistics.Strength, intelligence: OSE.statistics.Intelligence,
        ...
        Languages: Alignment, Common, Gnomish, Dwarvish, Kobold, secret language of burrowing mammals
        """
        self.STR = strength
        ...
        self.level_progression = {1:  [     0, "1d4", 0, 8, 9, 10, 14, 11],
                                  2:  [  3000, "2d4", 0, 8, 9, 10, 14, 11],
                                  3:  [  6000, "3d4", 0, 8, 9, 10, 14, 11],
                                  4:  [ 12000, "4d4", 0, 8, 9, 10, 14, 11],
                                  5:  [ 30000, "5d4", 0, 8, 9, 10, 14, 11],
                                  6:  [ 60000, "6d4", 2, 6, 7,  8, 11,  9],
                                  7:  [120000, "7d4", 2, 6, 7,  8, 11,  9],
                                  8:  [240000, "8d4", 2, 6, 7,  8, 11,  9],
                                  }
