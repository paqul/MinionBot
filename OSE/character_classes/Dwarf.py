...
class Dwarf(object):
    def __init__(self, strength: OSE.statistics.Strength, intelligence: OSE.statistics.Intelligence,
        ...
        self.character_class = "Krasnolud"
        self.level = 1
        self.hit_points = 0
        ...
        self.level_progression = {1:  [     0, "1d8", 0, 8, 9, 10, 13, 12],
                                  2:  [  2200, "2d8", 0, 8, 9, 10, 13, 12],
                                  3:  [  4400, "3d8", 0, 8, 9, 10, 13, 12],
                                  4:  [  8800, "4d8", 2, 6, 7,  8, 10, 10],
                                  5:  [ 17000, "5d8", 2, 6, 7,  8, 10, 10],
                                  6:  [ 35000, "6d8", 2, 6, 7,  8, 10, 10],
                                  7:  [ 70000, "7d8", 5, 4, 5,  6,  7,  8],
                                  8:  [140000, "8d8", 5, 4, 5,  6,  7,  8],
                                  9:  [270000, "9d8", 5, 4, 5,  6,  7,  8],
                                  10: [400000, "9d8", 7, 2, 3,  4,  4,  6],
